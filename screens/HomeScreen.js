    ...
    <>
      <View style={styles.container}>
        ...
        <View style={styles.fullName}>
          <TouchableOpacity  onPress={()=>navigation.navigate('Profile')} style={{height:50,width:50,backgroundColor:'cyan',marginHorizontal:10,borderRadius:25,justifyContent:'center',alignItems:'center'}}>
            <Text style={{fontWeight:'900',fontSize:25}}>{shortName}</Text>
          </TouchableOpacity>
      ...
      <View style={styles.addButton}>
        ...
        >
          <MaterialCommunityIcons name='timeline-help' size={24} color='red' />
        </TouchableOpacity>
        <TouchableOpacity
          activeOpacity={0.5}
